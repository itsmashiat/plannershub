  ...
  return (
    <div>
      <section className="page-hero compact">
        ...
        <h1>Books mapped to PUST URP courses.</h1>
        <p className="muted">
          Access core textbooks and reference manuals mapped directly to your semester courses.
        </p>
      </section>
      ...
      {loading ? (
        ...
        <div className="glass-panel" style={{ padding: '40px', textAlign: 'center', color: 'var(--muted)' }}>
          ...
          <p style={{ marginTop: '8px', fontSize: '0.88rem' }}>Check again later or contact an administrator to upload books.</p>
        </div>
      )}
    </div>
  );
